...
-- dependent pair, the second value depends on the first value
...
/-
a proof of a forall proposition, is really just a proof that for any arbitrarily
selected element of the quantified type, there is a proof of the predicate applied to that object
-/

...
#check Eq 2 3     -- Lean's definition is the same
#check 2 = 3      -- We generally use infix notation
...
| mk (a b : Nat) (h : b = a.succ) : succ_rel a b

example : succ_rel 2 3 := succ_rel.mk 2 3 rfl

example : ¬ succ_rel 2 4 := λ k => nomatch k

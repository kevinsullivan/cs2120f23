...
def a_pair_string_nat : Prod String Nat := Prod.mk "Love" 4
def a_pair_nat_bool : Prod Nat Bool := Prod.mk 5 false
...
#eval first (Prod.mk 2 "Hi")         -- 2
#eval second (Prod.mk 2 "Hi")        -- "Hi"
...
-- Lean defines a standard *mathematical notation* for Prod.mk
def pair1 := ("Hello",5)
def pair2 := (17, false)
